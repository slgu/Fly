...
all:
	...
	ocamlc -o fly $(parser_dir)/scanner.cmo $(parser_dir)/parser.cmo $(ast_dir)/ast.cmo $(ast_dir)/sast.cmo $(check_dir)/util.cmo $(check_dir)/infer.cmo fly.cmo
...
gen:
	...
	ocamlc -o fly $(parser_dir)/scanner.cmo $(parser_dir)/parser.cmo $(ast_dir)/ast.cmo $(ast_dir)/sast.cmo $(check_dir)/util.cmo $(check_dir)/infer.cmo $(gen_dir)/codegen.cmo fly_testgen.cmo
	cat test/test1 | ./fly
	g++ tmp.cc
	./a.out
